...
a persistence unit "MajorCityPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "MajorCity/pom.xml":
...
artifacts ("MajorCity-ejb.jar" and "MajorCity-web.war") are already built. You can build
